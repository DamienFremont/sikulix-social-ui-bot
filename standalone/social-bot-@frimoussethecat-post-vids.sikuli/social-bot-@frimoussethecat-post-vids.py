...
try:
    ...
    runScript("../platform/youtube-post-vid", ARG_TXT, ARG_IMG_DIR, ARG_IMG_NAM)
    ...
    # TODO runScript("../platform/twitter-post-vid", ARG_TXT, ARG_IMG_DIR, ARG_IMG_NAM)
        
    # facebook
    #runScript("../platform/firefox-container-open", ARG_FFC_ID)
    #runScript("../platform/firefox-mobile")
    #runScript("../platform/facebook-open")
    # TODO runScript("../platform/facebook-post-vid", ARG_TXT, "true")

    # vimeo
    #runScript("../platform/firefox-container-open", ARG_FFC_ID)
    #runScript("../platform/firefox-mobile")
    #runScript("../platform/vimeo-open")
    # TODO runScript("../platform/vimeo-post-vid", ARG_TXT, "true")
